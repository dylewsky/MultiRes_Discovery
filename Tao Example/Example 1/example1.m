...
for i=1:TimeSteps
    ...
    k1=[(3*r*b^2*cos(theta)+r*sin(theta)/epsilon)/(3*b^2+1); ...

        (r*cos(theta)-r*sin(theta)/epsilon)/(1+3*b^2); ...
    ...
    k2=[(3*r*b^2*cos(theta)+r*sin(theta)/epsilon)/(3*b^2+1); ...
    ...
    k3=[(3*r*b^2*cos(theta)+r*sin(theta)/epsilon)/(3*b^2+1); ...
    ...
    k4=[(3*r*b^2*cos(theta)+r*sin(theta)/epsilon)/(3*b^2+1); ...
